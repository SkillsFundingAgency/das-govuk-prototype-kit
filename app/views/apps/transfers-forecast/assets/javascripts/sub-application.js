    ...
    Tabletop.init( { key: publicSpreadsheetUrl1,
      ...
      loadArray(data);
       ...
       for (i = 0; i < data.length; i++) {
             //console.log(i)
           pos = i + 1;
content += '<tr><td class="nowrap">'+data[i].year+'</td><td class="financial">£'+data[i].transfer_allowance+'</td><td class="financial">£'+data[i].cost_of_training+'</td><td class="financial">£'+data[i].transfer_allowance_remaining+'</td><td class="financial"><a href="monthly-transfer-forecast.html">Details</td></tr>';
           renderTable(content);
            }
        }   
    ...
    Tabletop.init( { key: publicSpreadsheetUrl2,
      ...
      loadArray2(data);
       ...
       for (i = 0; i < data.length; i++) {
             //console.log(i)
           pos = i + 1;
content += '<tr><td class="nowrap">'+data[i].Apprenticeship+'<span class="form-hint">level '+ data[i].apprenticeship_level +'</span></td><td class="financial">£'+data[i].total_cost+'</td><td class="financial">£'+data[i].cost_in_1819+'</td><td class="financial">£'+data[i].cost_in_1920+'</td><td class="financial">£'+data[i].cost_in_2021+'</td><td class="financial">£'+data[i].cost_in_2122+'</td></tr>';
